...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
    ...
    $query=mysqli_query($con, "insert into tblgallery(image) value('$newimage')");
    if ($query) {
    	echo "<script>alert('gallery has been added.');</script>"; 
...
<html>
<head>
<title>Sandy's Threading | Add Gallery</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Add Gallery</h3>
