        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li class="">
              ...
              <li>
              <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>Gallery<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
             ...
             <li>
              <a href="add-staff.php"><i class="fa fa-cogs nav_icon"></i>Staff<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
